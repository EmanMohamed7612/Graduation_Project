  ...
  Widget build(BuildContext context) {
    ...
    return MultiBlocProvider(
      providers: [
        ...
        // 1️⃣ النسخة الأساسية والموحدة للـ FavoriteCubit تم تثبيتها هنا وتمرير الـ API Service لها
        ...
        // ❌ تم إزالة الـ BlocProvider<FavoriteCubit> المكرر الذي كان موجوداً هنا لمنع تضارب الحالات
