...
import 'feauture/message/manager/inboxmessage_cubit.dart';
import 'feauture/message/manager/message_repo.dart';
    ...
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider<InboxCubit>(
          create: (context) => InboxCubit(InboxRepo()), // استخدمي الـ Repo الصح مباشرة
        ),
  ...
  Widget build(BuildContext context) {
    ...
    return MultiBlocProvider(
      providers: [
        ...
        // ✅ النسخة الوحيدة والموحدة من الكارد cubit على مستوى التطبيق بالكامل
        BlocProvider(
          create: (_) => CartCubit(
            repo: CartRepo(),
            cartId: userId,
        ...
        BlocProvider(
          create: (context) => UserProfileCubit(UserProfileRepo())..fetchProfile(),
        ),
        BlocProvider(
          create: (context) => CreateProductCubit(
            repoProduct: RepoProductImple(
        ...
        BlocProvider<InboxCubit>(
          create: (context) => InboxCubit(InboxRepo()),
        ),
        BlocProvider(create: (context) => ExpertServiceCubit()),
        BlocProvider(create: (context) => ChatBotCubit(ChatBotRepo())),
        BlocProvider(
        ...
        BlocProvider(
          create: (context) => CategoryCubit(ProductApiService())..fetchCategories(),
        ),
        BlocProvider(
          create: (context) => UpdateProductCubit(
            repoProduct: RepoProductImple(
        ...
        BlocProvider(
          create: (context) => CategorymaterialCubit(MaterialApiService())..fetchmaterialCategories(),
        ),
        BlocProvider<AddAddressCubit>(
...
// ✅ 1. تحديث الـ Import ليستدعي الـ Cubit الموحد الجديد للمفضلة
...
import 'package:graduation2/feauture/order_screen/add_address_screens/manager/add_address_apiservces.dart';
import 'package:graduation2/feauture/order_screen/add_address_screens/manager/add_address_cubit.dart';
import 'package:graduation2/feauture/order_screen/deliver_screen/manager/getuseraddress_apiserves.dart';
import 'package:graduation2/feauture/order_screen/deliver_screen/manager/getuseraddress_cubit.dart';
...
import 'package:graduation2/feauture/product_screens/data/repo/repo_product_imple.dart';
...
import 'package:graduation2/feauture/product_screens/presentation/view/addprodect_screen/creatprodect.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return MultiBlocProvider(
      providers: [
        ...
        // ✅ 2. استبدال الكيوبيت القديم بـ MyFavoriteCubit الموحد ليعمل على مستوى التطبيق بالكامل
        BlocProvider<MyFavoriteCubit>(
          create: (context) => MyFavoriteCubit(favoriteApiService),
        ),
