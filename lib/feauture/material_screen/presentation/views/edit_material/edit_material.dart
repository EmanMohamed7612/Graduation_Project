...
class EditmaterialScreen extends StatefulWidget {
  ...
  const EditmaterialScreen({super.key, required this.product});
...
class _EditmaterialScreenState extends State<EditmaterialScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocConsumer<UpdatematerialCubit, UpdatematerialState>(
        ...
        // },
        listener: (context, state) {
          if (state is UpdatesupplierSuccessState) {
            ScaffoldMessenger.of(context).showSnackBar(
              ...
              children: [
                ...
                BlocBuilder<CategorymaterialCubit, CategorymaterialState>(
                  builder: (context, CategorymaterialState) {
                    ...
                    final categories = CategorymaterialState is CategorymaterialSuccess
                  ...
                  children: [
                    ...
                    Expanded(
                      child: ElevatedButton(
                        ...
                        onPressed: state is UpdatesupplierLoadingState
                            ? null
                            : () {
                          context.read<UpdatematerialCubit>().updatematerial(
                            UpdatematerialRequestModel(
                        ...
                        child: state is UpdatesupplierLoadingState
                            ? const SizedBox(
                          height: 20,
                          width: 20,
