      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            // زر Load More الموجود في التصميم
            Center(
              child: TextButton(
                onPressed: () {},
                child: Container(
                  ...
                  child: const Center(child: Text("Load More Products", style: TextStyle(color: Colors.black))),
                ),
              ),
            )
          ],
        ...
        Navigator.push(
          ...
          MaterialPageRoute(
            builder: (context) => ProductDetails(
              productId: product.id, // ✅ تمرير الـ id الخاص بالمنتج
            ),
          ),
        );
      },
            ...
            child: Stack(
              children: [
                ...
                Positioned(
                  top: 8,
                  right: 8,
                  child: BlocBuilder<FavoriteCubit, List<int>>( // تأكدي من اسم الكلاس هنا
                    builder: (context, favorites) {
                      final isFav = favorites.contains(product.id);
                      return GestureDetector(
                        onTap: () {
                          // هدا السطر هو المسؤول عن إرسال الإشارة للهوم
