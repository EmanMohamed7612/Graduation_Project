...
// import 'package:graduation2/feauture/product/view/widgets/product_card_recommendtion.dart';
...
//                 return ProductCardRecommendtion(
//                   title: product.name,
...
class RecommendationScreen extends StatelessWidget {
  final int productId; // تمرير الـ id الخاص بالمنتج الحالي

  const RecommendationScreen({super.key, required this.productId});
                  ...
                  return GridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return ProductCardRecommendtion(
                        ...
                        onTap: () {
                          print('Product tapped: ${product.id}');
                          // يمكنك هنا الانتقال لصفحة تفاصيل المنتج الجديد باستخدام product.id
                        },
                      );
                    },
                  );
