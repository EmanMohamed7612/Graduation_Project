...
class SellerbeginerDashboardScreen extends StatefulWidget {
  ...
  @override
  State<SellerbeginerDashboardScreen> createState() => _SellerbeginerDashboardScreenState();
}

class _SellerbeginerDashboardScreenState extends State<SellerbeginerDashboardScreen> {
                                      ...
                                      SnackBar(
                                        content: Row(
                                          children: [
                                            ...
                                            Text(LocaleKeys.Productdeletedsuccess.tr(),
