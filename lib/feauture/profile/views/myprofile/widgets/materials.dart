...
class RawMatrialGrid extends StatelessWidget {
  const RawMatrialGrid({super.key, required this.user});
  final user;
  @override
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<ProductCountCubit, ProductCountState>(
      builder: (context, countState) {
        ...
        if (countState is RawMaterialCountSuccess && countState.count == 0) {
          return const Center(
        ...
        if (countState is RawMaterialCountSuccess) {
